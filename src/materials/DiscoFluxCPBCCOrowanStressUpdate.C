...
------------*/
#include "DiscoFluxCPBCCOrowanStressUpdate.h"
...
InputParameters
DiscoFluxCPBCCOrowanStressUpdate::validParams()
{
...
DiscoFluxCPBCCOrowanStressUpdate::DiscoFluxCPBCCOrowanStressUpdate(const InputParameters & parameters)
  : CrystalPlasticityOrowanStressUpdateBase(parameters),
    ...
    _DD_EdgePositive_13(        coupledValue("DD_EdgePositive_13")),
    _DD_EdgePositive_14(        coupledValue("DD_EdgePositive_14")),
    _DD_EdgePositive_15(        coupledValue("DD_EdgePositive_15")),
    _DD_EdgePositive_16(        coupledValue("DD_EdgePositive_16")),
    _DD_EdgePositive_17(        coupledValue("DD_EdgePositive_17")),
    _DD_EdgePositive_18(        coupledValue("DD_EdgePositive_18")),
    _DD_EdgePositive_19(        coupledValue("DD_EdgePositive_19")),
    _DD_EdgePositive_20(        coupledValue("DD_EdgePositive_20")),
    _DD_EdgePositive_21(        coupledValue("DD_EdgePositive_21")),
    _DD_EdgePositive_22(        coupledValue("DD_EdgePositive_22")),
    _DD_EdgePositive_23(        coupledValue("DD_EdgePositive_23")),
    _DD_EdgePositive_24(        coupledValue("DD_EdgePositive_24")),
    ...
    _DD_EdgeNegative_13(        coupledValue("DD_EdgeNegative_13")),
    _DD_EdgeNegative_14(        coupledValue("DD_EdgeNegative_14")),
    _DD_EdgeNegative_15(        coupledValue("DD_EdgeNegative_15")),
    _DD_EdgeNegative_16(        coupledValue("DD_EdgeNegative_16")),
    _DD_EdgeNegative_17(        coupledValue("DD_EdgeNegative_17")),
    _DD_EdgeNegative_18(        coupledValue("DD_EdgeNegative_18")),
    _DD_EdgeNegative_19(        coupledValue("DD_EdgeNegative_19")),
    _DD_EdgeNegative_20(        coupledValue("DD_EdgeNegative_20")),
    _DD_EdgeNegative_21(        coupledValue("DD_EdgeNegative_21")),
    _DD_EdgeNegative_22(        coupledValue("DD_EdgeNegative_22")),
    _DD_EdgeNegative_23(        coupledValue("DD_EdgeNegative_23")),
    _DD_EdgeNegative_24(        coupledValue("DD_EdgeNegative_24")),
    ...
    _DD_ScrewPositive_13(       coupledValue("DD_ScrewPositive_13")),
    _DD_ScrewPositive_14(       coupledValue("DD_ScrewPositive_14")),
    _DD_ScrewPositive_15(       coupledValue("DD_ScrewPositive_15")),
    _DD_ScrewPositive_16(       coupledValue("DD_ScrewPositive_16")),
    _DD_ScrewPositive_17(       coupledValue("DD_ScrewPositive_17")),
    _DD_ScrewPositive_18(       coupledValue("DD_ScrewPositive_18")),
    _DD_ScrewPositive_19(       coupledValue("DD_ScrewPositive_19")),
    _DD_ScrewPositive_20(       coupledValue("DD_ScrewPositive_20")),
    _DD_ScrewPositive_21(       coupledValue("DD_ScrewPositive_21")),
    _DD_ScrewPositive_22(       coupledValue("DD_ScrewPositive_22")),
    _DD_ScrewPositive_23(       coupledValue("DD_ScrewPositive_23")),
    _DD_ScrewPositive_24(       coupledValue("DD_ScrewPositive_24")),
    ...
    _DD_ScrewNegative_13(       coupledValue("DD_ScrewNegative_13")),
    _DD_ScrewNegative_14(       coupledValue("DD_ScrewNegative_14")),
    _DD_ScrewNegative_15(       coupledValue("DD_ScrewNegative_15")),
    _DD_ScrewNegative_16(       coupledValue("DD_ScrewNegative_16")),
    _DD_ScrewNegative_17(       coupledValue("DD_ScrewNegative_17")),
    _DD_ScrewNegative_18(       coupledValue("DD_ScrewNegative_18")),
    _DD_ScrewNegative_19(       coupledValue("DD_ScrewNegative_19")),
    _DD_ScrewNegative_20(       coupledValue("DD_ScrewNegative_20")),
    _DD_ScrewNegative_21(       coupledValue("DD_ScrewNegative_21")),
    _DD_ScrewNegative_22(       coupledValue("DD_ScrewNegative_22")),
    _DD_ScrewNegative_23(       coupledValue("DD_ScrewNegative_23")),
    _DD_ScrewNegative_24(       coupledValue("DD_ScrewNegative_24")),
    ...
    _DD_EdgePositive_13_Grad(   coupledGradient("DD_EdgePositive_13")),
    _DD_EdgePositive_14_Grad(   coupledGradient("DD_EdgePositive_14")),
    _DD_EdgePositive_15_Grad(   coupledGradient("DD_EdgePositive_15")),
    _DD_EdgePositive_16_Grad(   coupledGradient("DD_EdgePositive_16")),
    _DD_EdgePositive_17_Grad(   coupledGradient("DD_EdgePositive_17")),
    _DD_EdgePositive_18_Grad(   coupledGradient("DD_EdgePositive_18")),
    _DD_EdgePositive_19_Grad(   coupledGradient("DD_EdgePositive_19")),
    _DD_EdgePositive_20_Grad(   coupledGradient("DD_EdgePositive_20")),
    _DD_EdgePositive_21_Grad(   coupledGradient("DD_EdgePositive_21")),
    _DD_EdgePositive_22_Grad(   coupledGradient("DD_EdgePositive_22")),
    _DD_EdgePositive_23_Grad(   coupledGradient("DD_EdgePositive_23")),
    _DD_EdgePositive_24_Grad(   coupledGradient("DD_EdgePositive_24")),
    ...
    _DD_EdgeNegative_13_Grad(   coupledGradient("DD_EdgeNegative_13")),
    _DD_EdgeNegative_14_Grad(   coupledGradient("DD_EdgeNegative_14")),
    _DD_EdgeNegative_15_Grad(   coupledGradient("DD_EdgeNegative_15")),
    _DD_EdgeNegative_16_Grad(   coupledGradient("DD_EdgeNegative_16")),
    _DD_EdgeNegative_17_Grad(   coupledGradient("DD_EdgeNegative_17")),
    _DD_EdgeNegative_18_Grad(   coupledGradient("DD_EdgeNegative_18")),
    _DD_EdgeNegative_19_Grad(   coupledGradient("DD_EdgeNegative_19")),
    _DD_EdgeNegative_20_Grad(   coupledGradient("DD_EdgeNegative_20")),
    _DD_EdgeNegative_21_Grad(   coupledGradient("DD_EdgeNegative_21")),
    _DD_EdgeNegative_22_Grad(   coupledGradient("DD_EdgeNegative_22")),
    _DD_EdgeNegative_23_Grad(   coupledGradient("DD_EdgeNegative_23")),
    _DD_EdgeNegative_24_Grad(   coupledGradient("DD_EdgeNegative_24")),
    ...
    _DD_ScrewPositive_13_Grad(  coupledGradient("DD_ScrewPositive_13")),
    _DD_ScrewPositive_14_Grad(  coupledGradient("DD_ScrewPositive_14")),
    _DD_ScrewPositive_15_Grad(  coupledGradient("DD_ScrewPositive_15")),
    _DD_ScrewPositive_16_Grad(  coupledGradient("DD_ScrewPositive_16")),
    _DD_ScrewPositive_17_Grad(  coupledGradient("DD_ScrewPositive_17")),
    _DD_ScrewPositive_18_Grad(  coupledGradient("DD_ScrewPositive_18")),
    _DD_ScrewPositive_19_Grad(  coupledGradient("DD_ScrewPositive_19")),
    _DD_ScrewPositive_20_Grad(  coupledGradient("DD_ScrewPositive_20")),
    _DD_ScrewPositive_21_Grad(  coupledGradient("DD_ScrewPositive_21")),
    _DD_ScrewPositive_22_Grad(  coupledGradient("DD_ScrewPositive_22")),
    _DD_ScrewPositive_23_Grad(  coupledGradient("DD_ScrewPositive_23")),
    _DD_ScrewPositive_24_Grad(  coupledGradient("DD_ScrewPositive_24")),
    ...
    _DD_ScrewNegative_13_Grad(  coupledGradient("DD_ScrewNegative_13")),
    _DD_ScrewNegative_14_Grad(  coupledGradient("DD_ScrewNegative_14")),
    _DD_ScrewNegative_15_Grad(  coupledGradient("DD_ScrewNegative_15")),
    _DD_ScrewNegative_16_Grad(  coupledGradient("DD_ScrewNegative_16")),
    _DD_ScrewNegative_17_Grad(  coupledGradient("DD_ScrewNegative_17")),
    _DD_ScrewNegative_18_Grad(  coupledGradient("DD_ScrewNegative_18")),
    _DD_ScrewNegative_19_Grad(  coupledGradient("DD_ScrewNegative_19")),
    _DD_ScrewNegative_20_Grad(  coupledGradient("DD_ScrewNegative_20")),
    _DD_ScrewNegative_21_Grad(  coupledGradient("DD_ScrewNegative_21")),
    _DD_ScrewNegative_22_Grad(  coupledGradient("DD_ScrewNegative_22")),
    _DD_ScrewNegative_23_Grad(  coupledGradient("DD_ScrewNegative_23")),
...
void
DiscoFluxCPBCCOrowanStressUpdate::initQpStatefulProperties()
{
  ...
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
  {
    ...
    _dislocation_mobile[_qp][i]       = (_DD_EdgeNegative[i] + _DD_EdgePositive[i] + _DD_ScrewPositive[i] + _DD_ScrewNegative[i]) * _dislo_density_factor_CDT;
    ...
    _dislocation_immobile_edge_positive[_qp][i]   = 0.25 * _dislo_density_initial;
    _dislocation_immobile_edge_negative[_qp][i]   = 0.25 * _dislo_density_initial;
    _dislocation_immobile_screw_positive[_qp][i]  = 0.25 * _dislo_density_initial;
    _dislocation_immobile_screw_negative[_qp][i]  = 0.25 * _dislo_density_initial;
...
DiscoFluxCPBCCOrowanStressUpdate::setInitialConstitutiveVariableValues()
{
  ...
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
  {
    ...
    _dislocation_mobile[_qp][i]       = (_DD_EdgePositive[i] + _DD_EdgeNegative[i] + _DD_ScrewPositive[i] + _DD_ScrewNegative[i]) * _dislo_density_factor_CDT;
    _dislocation_mobile_edge[_qp][i]  = (_DD_EdgePositive[i] + _DD_EdgeNegative[i]) * _dislo_density_factor_CDT;
    _dislocation_mobile_screw[_qp][i] = (_DD_ScrewPositive[i] + _DD_ScrewNegative[i]) * _dislo_density_factor_CDT;
  ...
  _previous_substep_dislocation_immobile_edge_positive  = _dislocation_immobile_edge_positive_old[_qp];
  _previous_substep_dislocation_immobile_edge_negative  = _dislocation_immobile_edge_negative_old[_qp];
  _previous_substep_dislocation_immobile_screw_positive = _dislocation_immobile_screw_positive_old[_qp];
  _previous_substep_dislocation_immobile_screw_negative = _dislocation_immobile_screw_negative_old[_qp];
}
...
DiscoFluxCPBCCOrowanStressUpdate::calculateSlipRate()
{
  ...
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
  {
    ...
    _kappa_screw[_qp][i]  = (_DD_ScrewPositive[i] - _DD_ScrewNegative[i]) * _dislo_density_factor_CDT;
  }
  return true;
}

void
DiscoFluxCPBCCOrowanStressUpdate::calculateConstitutiveSlipDerivative(std::vector<Real> & dslip_dtau)
{
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
  {
...
void
DiscoFluxCPBCCOrowanStressUpdate::calculateStateVariableEvolutionRateComponent()
{
...
// Calculate Dislocation Density increment
void
DiscoFluxCPBCCOrowanStressUpdate::getDDIncrements()
{
  Real small2 = 1.0e-5;
  Real A_f_ij;
  ...
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
  {
    ...
    _dislocation_forest[_qp][i]                       = 0.00;
    ...
    if (std::abs(_slip_increment[_qp][i]) > small2)
    {
      ...
      _dislocation_immobile_increment_screw_positive[i] =  frec_screwpos  * _C_trap * std::pow(_dislocation_forest[_qp][i], 0.5) * std::abs(_DD_ScrewPositive[i] * _dislo_velocity_screw[_qp][i]);
      _dislocation_immobile_increment_screw_negative[i] =  frec_screwneg  * _C_trap * std::pow(_dislocation_forest[_qp][i], 0.5) * std::abs(_DD_ScrewNegative[i] * _dislo_velocity_screw[_qp][i]);
...
DiscoFluxCPBCCOrowanStressUpdate::updateStateVariables()
{
  ...
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
  {
    _dislocation_immobile_edge_positive[_qp][i]   = _previous_substep_dislocation_immobile_edge_positive[i]   + _dislocation_immobile_increment_edge_positive[i] * _substep_dt;
    _dislocation_immobile_edge_negative[_qp][i]   = _previous_substep_dislocation_immobile_edge_negative[i]   + _dislocation_immobile_increment_edge_negative[i] * _substep_dt;
    _dislocation_immobile_screw_positive[_qp][i]  = _previous_substep_dislocation_immobile_screw_positive[i]  + _dislocation_immobile_increment_screw_positive[i] * _substep_dt;
    _dislocation_immobile_screw_negative[_qp][i]  = _previous_substep_dislocation_immobile_screw_negative[i]  + _dislocation_immobile_increment_screw_negative[i] * _substep_dt;
    _dislocation_immobile[_qp][i] = _dislocation_immobile_edge_positive[_qp][i] + _dislocation_immobile_edge_negative[_qp][i]
                                  + _dislocation_immobile_screw_positive[_qp][i] + _dislocation_immobile_screw_negative[_qp][i];
...
void
DiscoFluxCPBCCOrowanStressUpdate::DDCUpdate()
{
...
void
DiscoFluxCPBCCOrowanStressUpdate::getDisloVelocity()
{
  ...
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
  {
    ...
    if (tau_effAbs[i] > 0.0)
    {
      ...
      else
      {
        ...
        if (_mean_free_path_init_flag)
        {
          if (vel_run[i] < small2) _dislo_velocity_edge[_qp][i] = 0;
          else 
          {
        ...
        _dv_dtau[i] = (vel_run[i] < small2) ? 0.0 : 
  ...
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
  {
    ...
    if (tau_effAbs[i] > 0.0)
    {
      ...
      else
      {
        ...
        if (_mean_free_path_init_flag)
        {
          if (vel_run[i] < small2) _dislo_velocity_screw[_qp][i] = 0;
          else
          {
