...
DiscoFluxCPStressUpdate::validParams()
{
  ...
  params.addRequiredCoupledVar("DD_EdgePositive_1", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_2", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_3", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_4", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_5", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_6", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_7", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_8", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_9", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_10", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_11", "Coupled dislocation density, EdgePositive");
  params.addRequiredCoupledVar("DD_EdgePositive_12", "Coupled dislocation density, EdgePositive");

  params.addRequiredCoupledVar("DD_EdgeNegative_1", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_2", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_3", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_4", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_5", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_6", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_7", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_8", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_9", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_10", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_11", "Coupled dislocation density, EdgeNegative");
  params.addRequiredCoupledVar("DD_EdgeNegative_12", "Coupled dislocation density, EdgeNegative");

  params.addRequiredCoupledVar("DD_ScrewPositive_1", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_2", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_3", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_4", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_5", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_6", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_7", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_8", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_9", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_10", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_11", "Coupled dislocation density, ScrewPositive");
  params.addRequiredCoupledVar("DD_ScrewPositive_12", "Coupled dislocation density, ScrewPositive");

  params.addRequiredCoupledVar("DD_ScrewNegative_1", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_2", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_3", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_4", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_5", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_6", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_7", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_8", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_9", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_10", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_11", "Coupled dislocation density, ScrewNegative");
  params.addRequiredCoupledVar("DD_ScrewNegative_12", "Coupled dislocation density, ScrewNegative");
