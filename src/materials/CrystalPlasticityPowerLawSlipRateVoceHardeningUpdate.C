...
#include "CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate.h"
#include "libmesh/int_range.h"

registerMooseObject("discopanterApp", CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate);

InputParameters
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::validParams()
{
...
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::
...
void
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::initQpStatefulProperties()
{
...
void
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::setInitialConstitutiveVariableValues()
{
...
void
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::setSubstepConstitutiveVariableValues()
{
...
bool
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::calculateSlipRate()
{
  for (const auto i : make_range(_number_slip_systems))
  {
...
void
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::calculateEquivalentSlipIncrement(
...
void
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::calculateConstitutiveSlipDerivative(
...
bool
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::areConstitutiveStateVariablesConverged()
{
...
void
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::updateSubstepConstitutiveVariableValues()
{
  // Would also set substepped dislocation densities here if included in this model
...
void
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::cacheStateVariablesBeforeUpdate()
{
  _slip_resistance_before_update = _slip_resistance[_qp];
}

void
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::calculateStateVariableEvolutionRateComponent()
{
  for (const auto i : make_range(_number_slip_systems))
  {
  ...
  for (const auto i : make_range(_number_slip_systems))
  {
    _slip_increment_sum += std::abs(_slip_increment[_qp][i]);
  }

  for (const auto i : make_range(_number_slip_systems))
  {
    _slip_resistance_increment[i] += _hb[i] * _slip_increment_sum;
  }
}

bool
CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate::updateStateVariables()
{
