...
#include "ComputeMultipleCrystalPlasticityOrowanStress.h"
...
InputParameters
ComputeMultipleCrystalPlasticityOrowanStress::validParams()
{
...
ComputeMultipleCrystalPlasticityOrowanStress::ComputeMultipleCrystalPlasticityOrowanStress(
...
void
ComputeMultipleCrystalPlasticityOrowanStress::initQpStatefulProperties()
{
...
void
ComputeMultipleCrystalPlasticityOrowanStress::computeQpStress()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
    _models[i]->setQp(_qp);
                                                           ...
                                                           RankFourTensor & jacobian_mult)
{
  ...
  do
  {
    ...
    if (substep_iter > _max_substep_iter && _convergence_failed)
      mooseException("ComputeMultipleCrystalPlasticityOrowanStress: Constitutive failure");
...
void
ComputeMultipleCrystalPlasticityOrowanStress::preSolveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
...
void
ComputeMultipleCrystalPlasticityOrowanStress::solveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
...
void
ComputeMultipleCrystalPlasticityOrowanStress::postSolveQp(RankTwoTensor & cauchy_stress,
                                                          RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityOrowanStress::solveStateVariables()
{
  ...
  do
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputeMultipleCrystalPlasticityOrowanStress: State variables (or the system "
  ...
  if (iteration == _maxiterg)
  {
    if (_print_convergence_message)
      mooseWarning(
          "ComputeMultipleCrystalPlasticityOrowanStress: Hardness Integration error. Reached the "
...
void
ComputeMultipleCrystalPlasticityOrowanStress::solveStress()
{
  ...
  if (_convergence_failed)
  {
    if (_print_convergence_message)
      mooseWarning(
          "ComputeMultipleCrystalPlasticityOrowanStress: the slip increment exceeds tolerance "
          "at element ",
          _current_elem->id(),
          " and Gauss point ",
          _qp);
  ...
  while (rnorm > _rtol * rnorm0 && rnorm > _abs_tol && iteration < _maxiter)
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputeMultipleCrystalPlasticityOrowanStress: Failed with line search");
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputeMultipleCrystalPlasticityOrowanStress: Stress Integration error rmax = ",
                   rnorm,
...
void
ComputeMultipleCrystalPlasticityOrowanStress::calculateResidualAndJacobian()
{
  calculateResidual();
  if (_convergence_failed)
    return;
...
void
ComputeMultipleCrystalPlasticityOrowanStress::calculateResidual()
{
...
void
ComputeMultipleCrystalPlasticityOrowanStress::calculateJacobian()
{
...
void
ComputeMultipleCrystalPlasticityOrowanStress::calcTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityOrowanStress::elastoPlasticTangentModuli(
    RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityOrowanStress::elasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
bool
ComputeMultipleCrystalPlasticityOrowanStress::lineSearchUpdate(const Real & rnorm_prev,
...
void
ComputeMultipleCrystalPlasticityOrowanStress::calculateEigenstrainDeformationGrad()
{
  _inverse_eigenstrain_deformation_grad.zero();
  _inverse_eigenstrain_deformation_grad.addIa(1.0);
