...
#include "ConservativeAdvectionDislocationConstVel.h"

registerMooseObject("discopanterApp", ConservativeAdvectionDislocationConstVel);

InputParameters
ConservativeAdvectionDislocationConstVel::validParams()
{
...
ConservativeAdvectionDislocationConstVel::ConservativeAdvectionDislocationConstVel(
...
Real
ConservativeAdvectionDislocationConstVel::negSpeedQp() const
{
  Real dislo_sign;
  ...
  switch (_dislocationcharacter)
  {
    case DislocationCharacter::edge:
      ...
      for (unsigned int j = 0; j < LIBMESH_DIM; ++j)
      {
        ...
        disvelocity(j) *= (*_dislo_velocity)[_qp] * dislo_sign;
      }
      break;
...
Real
ConservativeAdvectionDislocationConstVel::computeQpResidual()
{
...
Real
ConservativeAdvectionDislocationConstVel::computeQpJacobian()
{
  // This is the no-upwinded version
...
void
ConservativeAdvectionDislocationConstVel::computeResidual()
{
  switch (_upwinding)
  {
...
void
ConservativeAdvectionDislocationConstVel::computeJacobian()
{
  switch (_upwinding)
  {
    case UpwindingType::none:
...
void
ConservativeAdvectionDislocationConstVel::fullUpwind(JacRes res_or_jac)
{
