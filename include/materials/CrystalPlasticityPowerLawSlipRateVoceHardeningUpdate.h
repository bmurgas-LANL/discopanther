...
class CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate;

/**
 * CrystalPlasticityPowerLawSlipRateVoceHardeningUpdate uses the multiplicative decomposition of the
