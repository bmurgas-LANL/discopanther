...
/**
 * ComputeMultipleCrystalPlasticityOrowanStress (used together with
 * CrystalPlasticityOrowanStressUpdateBase) uses the multiplicative decomposition of the deformation
 ...
 */
class ComputeMultipleCrystalPlasticityOrowanStress : public ComputeFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  ComputeMultipleCrystalPlasticityOrowanStress(const InputParameters & parameters);
...
protected:
  ...
  std::vector<CrystalPlasticityOrowanStressUpdateBase *> _models;
